...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:str="http://www.metaphoricalweb.org/xmlns/string-utilities"
                xmlns:xs="http://www.w3.org/2001/XMLSchema"
                xmlns:util="http://blank" version="2.0">
            ...
            <xsl:for-each select="DISS_submission">
                <document>
                    ...
                    <disciplines>
                        <xsl:for-each
                            ...
                            <xsl:choose>
                                ...
                                <xsl:when test=".='Aquatic sciences'">
                                    <discipline>Terrestrial and Aquatic Ecology</discipline>
                                </xsl:when>
                                ...
                                <xsl:when test=".='Behavioral psychology'">
                                    <discpline>Applied Behavior Analysis</discpline>
                                </xsl:when>
                                ...
                                <xsl:when test=".='Biochem, Biophysics, and Molecular Biology'">
                                    <discipline>Biochemistry, Biophysics, and Molecular Biology</discipline>
                                </xsl:when>
                                ...
                                <xsl:when test=".='Creative writing'">
                                    <discipline>Creative Writing</discipline>
                                </xsl:when>
                                ...
                                <xsl:when test=".='Early childhood education'">
                                    <discipline>Pre-Elementary, Early Childhood, Kindergarten Teacher Education
                                    </discipline>
                                </xsl:when>
                                ...
                                <xsl:when test=".='Education,School of'">
                                ...
                                <xsl:when test=".='Elementary education'">
                                    <discipline>Elementary and Middle and Secondary Education Administration
                                    </discipline>
                                ...
                                <xsl:when test=".='English literature'">
                                    <discipline>English Language and Literature</discipline>
                                </xsl:when>
                                ...
                                <xsl:when test=".='Fashion'">
                                    <discipline>Fashion Design</discipline>
                                    <discipline>American Material Culture</discipline>
                                </xsl:when>
                                ...
                                <xsl:when test=".='Medical imaging and radiology'">
                                    ...
                                    <discipline>Analytical, Diagnostic and Therapeutic Techniques and Equipment
                                    </discipline>
                                </xsl:when>
                                ...
                                <xsl:when test=".='Middle school education'">
                                    ...
                                    <discipline>Junior High, Intermediate, Middle School Education and Teaching
                                    </discipline>
                                </xsl:when>
                                ...
                                <xsl:when test=".='Multimedia communications'">
                                ...
                                <xsl:when test=".='Occupational safety'">
                                    <discipline>Occupational Health and Industrial Hygiene</discipline>
                                </xsl:when>
                                ...
                                <xsl:when test=".='Social research'">
                                    <discipline>Quantitative, Qualitative, Comparative, and Historical Methodologies
                                    </discipline>
                                </xsl:when>
                                ...
                                <xsl:when test=".='Veterinary science'">
                                    <discipline>Veterinary Medicine</discipline>
                                </xsl:when>
                    ...
                    <fulltext-url>
                        ...
                        <xsl:value-of
                                select="concat('https://behost.lib.iastate.edu/DR/uploads/', $pdfpath)"/>
                        ...
                        <xsl:for-each select="DISS_description/DISS_degree">
                            ...
                            <xsl:choose>
                                <xsl:when test="contains($degreestr1, 'M.A. and M.C.R.P.')">
                                    <xsl:value-of>Master of Arts/Master of Community and Regional Planning
                                    </xsl:value-of>
                                </xsl:when>
                                <xsl:when
                                ...
                                <xsl:when
                                    ...
                                    <xsl:value-of>Master of Architecture/Master of Business Administration
                                    </xsl:value-of>
                                </xsl:when>
                                <xsl:when
                                        test="contains($degreestr1, 'M.Arch.') and contains($degreestr1, 'M.C.R.P.')">
                                    <xsl:value-of>Master of Architecture/Master of Community and Regional Planning
                                    </xsl:value-of>
                                </xsl:when>
                                <xsl:when
                                ...
                                <xsl:when
                                    ...
                                    <xsl:value-of>Master of Community and Regional Planning/Master of Business
                                        Administration
                                    </xsl:value-of>
                                </xsl:when>
                                <xsl:when
                                ...
                                <xsl:when
                                    ...
                                    <xsl:value-of>Master of Landscape Architecture/Master of Community and Regional
                                        Planning
                                    </xsl:value-of>
                                </xsl:when>
                                <xsl:when
                                        test="contains($degreestr1, 'M.C.R.P.') and contains($degreestr1, 'M.P.A.')">
                                    <xsl:value-of>Master of Public Administration/Master of Community and Regional
                                        Planning
                                    </xsl:value-of>
                                </xsl:when>
                                <xsl:when
                                ...
                                <xsl:when
                                    ...
                                    <xsl:value-of>Master of Community and Regional Planning/Master of Science
                                    </xsl:value-of>
                                </xsl:when>
                                <xsl:when
                    ...
                    <department>
                        <xsl:for-each select="DISS_description/DISS_institution/DISS_inst_contact">
                            ...
                            <xsl:choose>
                                ...
                                <xsl:when test=".='Art and Visual Cultures'">
                                    <xsl:value-of>Art and Visual Culture</xsl:value-of>
                                </xsl:when>
                                <xsl:when test=".='Biochem, Biophysics, and Molecular Biology'">
                                ...
                                <xsl:when test=".='Meteorology program'">
                                    <xsl:value-of>Geological and Atmospheric Sciences</xsl:value-of>
                                </xsl:when>
                                ...
                                <xsl:when test=".='Veterinary Biomedical Sciences'">
                                ...
                                <xsl:choose>
                                    <xsl:when test="$accept_code = '0'">
                                        <xsl:choose>
                                            <xsl:when test="//DISS_restriction/DISS_sales_restriction[@code] != '0'">
                                                <xsl:variable name="removeDate"
                                                              select="//DISS_restriction/DISS_sales_restriction/@remove"/>
                                                <xsl:variable name="month" select="substring-before($removeDate,'/')"/>
                                                <xsl:variable name="day"
                                                              select="substring-before(substring-after($removeDate,'/'),'/')"/>
                                                <xsl:variable name="year"
                                                              select="substring-after(substring-after($removeDate,'/'),'/')"/>
                                                <xsl:value-of select="$year"/>
                                                <xsl:value-of select="'-'"/>
                                                <xsl:if test="string-length($month) = 1">
                                                    <xsl:value-of select="'0'"/>
                                    ...
                                    <xsl:when test="$accept_code = '1'">
                                        ...
                                        <xsl:variable name="fdate"
                                                      select="concat(substring($dateString, 1, 10), 'T', substring($dateString, 12, 19))"/>
                                        <xsl:choose>
                                                ...
                                                <xsl:choose>
                                                    <xsl:when test="//DISS_repository/DISS_delayed_release != ''">
                                                        <xsl:variable name="releaseDate"
                                                                      select="//DISS_repository/DISS_delayed_release"/>
